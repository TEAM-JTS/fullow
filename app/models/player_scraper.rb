class PlayerScraper
  ...
  def get_last_game_stats
    ...
    @most_recent_0 = {date: @last_game_stats[0][0], vs: @last_game_stats[0][1].sub('vs', 'vs '), score: @last_game_stats[0][2], minutes: @last_game_stats[0][3], fgam: @last_game_stats[0][4], threepointam: @last_game_stats[0][6], ftam: @last_game_stats[0][8], reb: @last_game_stats[0][10], ast: @last_game_stats[0][11], blk: @last_game_stats[0][12], stl: @last_game_stats[0][13], turnovers: @last_game_stats[0][15], pts: @last_game_stats[0][16]}
  ...
  def get_next_game_info
    @game_time_day = @player_data.css('.time').text.scan(/(\D+)(\d+:\d+\D+)/).flatten
